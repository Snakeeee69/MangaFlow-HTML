// Puntos actuales del usuario en memoria local
...
function actualizarVistaPuntos() {
  document.getElementById("puntos-usuario").innerText = puntosUsuario.toLocaleString("es-CL");
}
...
function canjear(nombre, costo) {
  ...
  // Bloquea el canje de puntos a usuarios sin sesión
  if (!usuario) {
